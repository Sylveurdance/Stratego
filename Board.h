...
namespace Game {
	...
	class Board {
		...
		public:
			...
			void putPiece(Piece* p, const Position& position, bool outBox=false);	// Put a Piece in a specific position on the field
			void removePiece(const Position& position, bool inBox=false); 			// Removes a piece from the game
